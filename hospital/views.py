...
#for showing signup/login button for admin(by jayati)
def adminclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'hospital/adminclick.html')

#for showing signup/login button for doctor(by jayati)
def doctorclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'hospital/doctorclick.html')

#for showing signup/login button for patient(by jayati)
...
#-----------for checking user is doctor , patient or admin(by jayati)
def is_admin(user):
